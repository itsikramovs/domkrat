...
export default function MerchantCountPage() {
      ...
      {whList.length === 0 ? (
        <Card>
          <CardContent className="p-6 text-sm text-muted-foreground">
            Нет своих складов. Создайте склад в разделе «Склады», затем проводите ревизию. (Для FBO
            остаток ведёт платформа.)
          </CardContent>
        </Card>
      ) : !activeId ? (
        <Card>
                      ...
                      <tr key={i.id}>
                        ...
                        <td className="px-2 py-2">
                          <div className="truncate">
                            {i.productName ? pickLocale(i.productName) : i.sku}
                          </div>
