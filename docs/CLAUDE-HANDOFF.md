...
**Блокеры боевого запуска (не делалось):** реальные платежи (Click/Payme/Uzum — 501 stubs), реальный SMS (Eskiz), legal. **Маркетплейс — ✅ доведён** (схема+бэкенд+миграция, админка, витрина buy-box, кабинет мерчанта, `seed.ts`, e2e под offer-модель). **Опционально осталось:** ценовые/числовые фасеты как range-слайдеры; алерты остатков пока агрегируются по (product,merchant), не по offer.
...
- **~480 .ts/.tsx файлов**
- **136 тестов** (89 unit + 47 E2E) — все зелёные
