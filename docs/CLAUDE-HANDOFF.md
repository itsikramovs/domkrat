...
### Если нужно **довести маркетплейс до конца** (осталось: поиск/seed, ~0.5 дня):

- ✅ Витрина (`/p/[slug]` buy-box), админ-панель управления товарами, кабинет мерчанта (управление офферами) — СДЕЛАНЫ (см. §0).
